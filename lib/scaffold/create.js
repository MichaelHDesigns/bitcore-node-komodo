...
var BASE_PACKAGE = {
  ...
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-komodo': 'git+https://git@github.com/HTHcoin/helpthehomeless-lib',
    'bitcore-node-komodo': 'git+https://git@github.com/MichaelHDesigns/bitcore-node-komodo'
  }
};
